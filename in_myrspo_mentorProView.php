...
<!--
	...
	<div id="spro6" class="tab-pane fade">
		...
		<div class="viewTab">
			...
			<div class="viewTab1"><h4>2. About Mentor</h4></div>
			<div class="viewTab1">
				<label class="col-md-3 col-sm-6">a. Product Knowledge</label>
				<div class="col-md-5 col-sm-6 text-bold">
					<div class="reviews1">
						<i class="fa fa-star"></i>&nbsp;
						<i class="fa fa-star"></i>&nbsp;
				...
				<label class="col-md-3 col-sm-6">b. Guidelines</label>
				<div class="col-md-5 col-sm-6 text-bold">
					<div class="reviews1">
						<i class="fa fa-star"></i>&nbsp;
						<i class="fa fa-star"></i>&nbsp;
				...
				<label class="col-md-3 col-sm-6">c. Interaction</label>
				<div class="col-md-5 col-sm-6 text-bold">
					<div class="reviews1">
						<i class="fa fa-star"></i>&nbsp;
						<i class="fa fa-star"></i>&nbsp;
				...
				<label class="col-md-3 col-sm-6">d. Time Mangement</label>
				<div class="col-md-5 col-sm-6 text-bold">
					<div class="reviews1">
						<i class="fa fa-star"></i>&nbsp;
						<i class="fa fa-star"></i>&nbsp;
