...
$query1 = "SELECT intern_applied_id, internship_id, user_id, comments, status FROM  too_intern_applied  WHERE intern_applied_id!='' ORDER BY intern_applied_id DESC";
//echo $query1;
...
<div class="table-responsive">
	...
	<?php $i=1; while($statement1->fetch()) {
		...
		$query3 = "SELECT s_first_name, s_last_name FROM  student_info  WHERE user_id=$user_id";
		//echo $query3;
	...
	?>
		...
		<tr>
			...
			<td><a href="myInternsView.php?insaid=<?php echo $intern_applied_id; ?>" class="btn"><i class="fa fa-search"></i></a></td>
		</tr>
	<?php $i++; } ?>
	</table>
</div>
