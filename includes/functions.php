...
function countryId($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT country_id, country_name FROM master_country WHERE status='A'";
...
function mentorstatus($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT subcategory_id, subcategory_name FROM master_subcategory where category_id='84' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
...
function stateId($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT state_id, state_name FROM master_state WHERE status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
...
function projectcategory($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='13' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
...
function busidomain($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='18' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id,$category_name);
...
function projectmethod($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='19' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id,$category_name);
...
function projectstatus($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='16' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id,$category_name);
...
function projdevplatform($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='21' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id,$category_name);
...
function tutorialCategory($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='22' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id,$category_name);
...
function learnVideosCategory($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='18' AND status='A'";
...
function assessmentCategory($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id,category_name FROM master_category where category_for='19' AND status='A'";
...
function projectId($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT subcategory_id,subcategory_name FROM master_subcategory where subcategory_id='$val' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($subcategory_id,$subcategory_name);
...
function rspname($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT representative_service_provider_details_id,rsp_name FROM representative_service_provider_details WHERE status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
...
function serviceprovider($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id, category_name FROM master_category where category_for='6' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id, $category_name);
...
function categoryname($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id, category_name FROM master_category WHERE status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id, $category_name);
...
function subcategoryname($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT subcategory_id, subcategory_name FROM master_subcategory WHERE status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($subcategory_id, $subcategory_name);
...
function category($val)
{
	global $mysqli;
	$status='A';
	$sql = "SELECT category_id, category_name FROM master_category where category_for='4' AND status='A'";
	$statement=$mysqli->prepare($sql);	
	$statement->execute();
	$statement->store_result();
	$statement->bind_result($category_id, $category_name);
...
{
	global $mysqli;
	$sql1 = "SELECT category_id,category_for,category_name FROM master_category where category_for='$category_for' AND status='A'";
...
{
	global $mysqli;
	$sql2 = "SELECT subcategory_id,subcategory_name FROM master_subcategory where category_id='$s_program' AND status='A'";
...
{
	global $mysqli;
	$sqls = "SELECT state_id,state_name FROM master_state where country_id='$country_id' AND status='A'";
...
{
	global $mysqli;
	$sqls = "SELECT city_id,city_name FROM master_city where state_id='$state_id' AND status='A'";
	$statements=$mysqli->prepare($sqls);	
	$statements->execute();
	$statements->store_result();
...
function getCountryName($val)
{
	global $mysqli;
	$status='A';
	$csql = "SELECT country_name FROM master_country WHERE country_id='$val' AND status='A'";
...
{
	global $mysqli;
	$sqls = "SELECT category_name FROM master_category where category_id='$val' AND status='A'";
	$statements=$mysqli->prepare($sqls);	
	$statements->execute();
	$statements->store_result();
...
{
	global $mysqli;
	$sqls = "SELECT subcategory_name FROM master_subcategory where subcategory_id='$val' AND status='A'";
	$statements=$mysqli->prepare($sqls);	
	$statements->execute();
	$statements->store_result();
...
{
	global $mysqli;
	$sqls = "SELECT state_name FROM master_state where state_id='$val' AND status='A'";
	$statements=$mysqli->prepare($sqls);	
	$statements->execute();
	$statements->store_result();
...
{
	global $mysqli;
	$sqls = "SELECT city_name FROM master_city where city_id='$val' AND status='A'";
	$statements=$mysqli->prepare($sqls);	
	$statements->execute();
	$statements->store_result();
...
function getMessageNotification($action)
    ...
    $message='';
		...
		$titleMsg="Success!";
            ...
            {
		$titleMsg="Notification!";
                $message='Please fill up the primary registration details.';
            }
...
function years($val1)
{
	...
	for($sday=$tday-100; $sday<=$tday; $sday++) {
		$selVal='';
		if($val1!=''){
			foreach($eligible_yoc as $val) {
				if($sday==$val)  $selVal="selected";
			}
		}
...
function get_subcategory($vals)
{
	...
	$query_for_subcat = "SELECT subcategory_name FROM  master_subcategory  WHERE subcategory_id=$vals AND status='A'";
...
/* GET All Name*/
function getValue($table_name, $result_col, $col_name, $col_val)
{
	global $mysqli;
	$query_getValue = "SELECT ".$result_col." FROM ".$table_name." WHERE ".$col_name."='$col_val'";
	$statement_getValue=$mysqli->prepare($query_getValue);
	$statement_getValue->execute();
	$statement_getValue->store_result();
	$statement_getValue->bind_result($result_val);
	$statement_getValue->fetch();
	$statement_getValue->close();
	return $result_val;	
}
