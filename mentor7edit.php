...
<div class="formss formss2">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<div class="liLine"></div>
			<a href="mentor2edit2.php?email=<?php echo $email;?>"></a>
			<div class="gap10"></div>Contact Info
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="mentor2edit3.php?email=<?php echo $email;?>"></a>
			<div class="gap10"></div>Educational Qualification
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="mentor7edit4.php?email=<?php echo $email;?>"></a>
			<div class="gap10"></div>Technical Skills
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="mentor7edit5.php?email=<?php echo $email;?>"></a>
			<div class="gap10"></div>Certification Details
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="mentor7edit6.php?email=<?php echo $email;?>"></a>
