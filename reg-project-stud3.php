...
if(isset($proceed_submit)){
	header("location:reg-project-stud4.php?email=$email");
}
			...
			<form method="post" id="form_qualification_reg">	
				<div class="table-responsive">
					<table width="100%" class="table table-striped border">
						...
						<tr>
						  ...
						  <td><span class="form-group">
						    <select class="form-control" name="s_year_of_completion" id="s_year_of_completion" readonly>
						      <option value="">Select</option>
						      <?php echo years($s_year_of_completion); ?>
						</select>
						  </span></td>
						  <td><span class="form-group">
						    <input type="text" name="s_percentage_achieved" id="s_percentage_achieved" class="form-control" placeholder="% Achieved" value="<?php echo $s_percentage_achieved1;?>"/>
						  </span></td>
						  <td><span class="form-group">
						    <input type="text" name="s_university_name" id="s_university_name" class="form-control" placeholder="University Name" value="<?php echo $s_university_name;?>"/>
						  </span></td>
						</tr>
						<tr class="tr1">
						...
						<tr>
						  <td><span class="form-group">
						    <input type="text" name="s_institution_name" id="s_institution_name" class="form-control" placeholder="Institution Name" value="<?php echo $s_institution_name;?>" maxlength="50"/>
						  </span></td>
						 <td><select class="form-control" name="s_institution_country" id="s_institution_country" >
						  ...
						  <td><span class="form-group">
						    <input type="tel" name="s_institution_zip" id="s_institution_zip" value="<?php echo $s_institution_zip;?>" class="form-control" placeholder="Institution Zip">
						  </span></td>
 ...
 while($statement1->fetch()) {
					...
					?>
						<tr>
							...
							<td align="right"><a href="reg-project-stud3.php?edit_id=<?php echo $s_qualification_id;?>"><i class="fa fa-pencil edit"></i></a><a class="delete" href="reg-project-stud3.php?delete_id=<?php echo $s_qualification_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
					</table>
				</div>
    ...
    JQUERY4U.UTIL =
    {
        setupFormValidation: function()
        {
           ...
           messages: {
					    ...
					    lettersnums: "Please enter characters and numbers only"
...
if(con=='')
{
$('#s_institution_state').html('<option>Select</option>');
}
else
{
   $.ajax({    //create an ajax request to functions.php
...
function empty_form(val1){
    ...
    $("#form_qualification_reg").find("input[type=text],input[type=tel],select").val("");
}
