			...
			<div class="item1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" class="form-control" name="s_addressline1" id="s_addressline1"  placeholder="Address Line" value="<?php echo $s_addressline1;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-newspaper-o"></i></span>
						<input type="text" class="form-control" name="s_addressline2" id="s_addressline2"  placeholder="Address Line" value="<?php echo $s_addressline2;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_primary_contact" id="s_primary_contact" class="form-control" onkeypress="javascript:return OnlyNumeric(this,event,false);" placeholder="10 Digit Number" style="width: 65%;" title="Enter Your Mobile Number" maxlength="10" value="<?php echo $s_primary_contact;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_email_id" id="s_email_id" onkeypress="javascript:return fncEmailValidate(event);" class="form-control" placeholder="Email" maxlength="50" value="<?php echo $umail;?>" readonly/>
						</div>
						<div class="gap1"></div>
						<span for="emailId" class="errors"></span>
					</div>
					<div class="gap1"></div>
				</div>
				<div class="gap15"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-envelope"></i></span>
						<input type="text" name="s_alternate_email_id" id="s_alternate_email_id"  onkeypress="javascript:return fncEmailValidate(event);"
OnPaste="return false;"  class="form-control" placeholder=" Alternate Email" maxlength="50" value="<?php echo $s_alternate_email_id;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_secondary_contact" id="s_secondary_contact" class="form-control" onkeypress="javascript:return OnlyNumeric(this,event,false);" placeholder="10 Digit Number" style="width: 65%;" title="Enter Your Mobile Number" maxlength="10" value="<?php echo $s_secondary_contact;?>"/>
						</div>
						<div class="gap1"></div>
