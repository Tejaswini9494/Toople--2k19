...
if(isset($submit_details)){
	...
	header("location:reg-project-stud5.php?email=$email");
}
				...
				<div class="table-responsive">
					<table width="100%" class="table table-striped border">
						...
						<tr>
							...
							<input type="text" name="s_exam_name" id="s_exam_name" placeholder="Exam Name" onkeypress="return alpha(event)" onchange="AllowOnlyAlphabates(this);" onpaste="return AllowOnlyAlphabates(this);" oncopy="return AllowOnlyAlphabates(this);" onblur="FormatString(this);" value="<?php echo $s_exam_name;?>" class="form-control" />
							</span></td>
							<td><span class="form-group">
							<input type="text" name="s_exam_code" id="s_exam_code" placeholder="Exam Code" value="<?php echo $s_exam_code;?>"class="form-control" />
							</span></td>
							<td><span class="form-group">
							<input type="text" name="s_date_of_cleared" id="s_date_of_cleared" placeholder="Date of Cleared" value="<?php echo $sdoc;?>"class="dateIcon form-control date2" readonly>
							</span></td>
...
?> 
			<tr>
				...
				<td align="right"><a href="reg-project-stud5.php?edit_id=<?php echo $s_certification_id;?>"><i class="fa fa-pencil edit"></i></a><a class="delete" href="reg-project-stud5.php?delete_id=<?php echo $s_certification_id;?>"><i class="fa fa-trash trash"></i></a></td>
			</tr>
					<?php } ?>
				</table>
			</div>
			...
			<div class="gap20"></div>
<div><span class="red">Note:</span> All information we collect is highly confidential, and keeping your information private, safe and secure is very important to us.</div>
		</div>
	</div>
...
function empty_form(val1){
    ...
    $("#form_certidetails_reg").find("input[type=text],input[type=tel],select").val("");
}
