...
if($statement1->num_rows() < 1) {
	$status='A';
	$query2 = "INSERT INTO draw_down_payment_details (user_id) VALUES($user_id)";
...
<div class="formss formss1">
	...
	<ul class="nav nav-tabs">
		<li class="active">
			...
			<div class="gap10"></div><?php echo $name12;?> 
		</li>
		<li class="active">
			<div class="liLine"></div>
...
<?php }?>
				...
				<div class="col-sm-9 col-sm-push-3">
					...
					<input type="button" class="btn submitM" name="reset1" id="reset1" value="Clear" onclick="empty_form1('reset1')">
				</div>
		</form>
				<div class="gap30"></div>
...
?>
						<tr>
							...
							<td align="right"><a href="reg-institution3.php?edit_id=<?php echo $co_agreement_id;?>"><i class="fa fa-pencil edit"></i></a><a class="delete" href="reg-institution3.php?delete_id=<?php echo $co_agreement_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
<?php } ?>
					</table>
				</div>
...
$("#ca_start_date").datepicker({
	...
	onClose:function(selectedDate) {
		...
		$("#ca_pay_date").datepicker("option","minDate",selectedDate);
}	
});
...
function empty_form(val1){
        $("#"+val1).closest('#draw_down').find("input[type=text], input[type=radio], input[type=tel], select, textarea").val("");
}
