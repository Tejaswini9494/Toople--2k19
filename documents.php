...
if(isset($Submit_diss)){
	...
	$fv = new FormValidator();
        ...
        //dbd_title
        $fv->isEmpty("dbd_title","Enter the document title");
        if($dbd_title!="") $fv ->isWithinLengthmin("dbd_title","Document Title - Enter atleast 3 characters","2");
	...
	$youtube_url=trim($_POST['youtube_url']);
        ...
        //$dbd_title1d=substr($dbd_title,0,-1);
        $dbd_title1d=str_replace('.',' ', $dbd_title);
        $dbd_title1=str_replace(' ','-', $dbd_title1d);
        
        session_start();
        $_SESSION['poppostdocumNOTI']="DISSNOTIdoc"; 
        $_SESSION['ses_discussion_id']=$dis_id_enc;
        header("location:".$ht_hurl."discussion/$dis_id_enc/0/$dbd_title1");
        exit;
}}
...
if(isset($Submit_prev)){
	...
	$fv = new FormValidator();
        ...
        //dbd_title
        $fv->isEmpty("dbd_title","Enter the document title");
        if($dbd_title!="") $fv ->isWithinLengthmin("dbd_title","Document Title - Enter atleast 3 characters","3");
	...
	$youtube_url=trim($_POST['youtube_url']);
        ...
        header("location:".$ht_hurl."discussion1_did/$dis_id_enc/$dbd_title1");
       // exit;
}}
...
<div class="gap20"></div>
<h1>Documents <a href="Javascript:history.back()" class="pull-right blue bold font16"><i class="fa fa-angle-double-right"></i> Back</a></h1>
<div class="gap10"></div>
...
<?php }?>  
<form id="document_valid"  method="POST" enctype="multipart/form-data">
<div class="discBox">
	<div class="form-group">
		Title <span class="red">*</span>
		<div class="gap5"></div>
		<input type="text" class="form-control" id="dbd_title" name="dbd_title" placeholder="Document Title" value="<?php echo $dbd_title;?>" autofocus>
	</div>
	<div class="form-group">
...
<div class="gap30"></div>
<div class="txtEdit1">
	<textarea name="dbd_content" id="dbd_content" ><?php echo $dbd_content;?></textarea>
</div>
...
<div class="accBox">
	...
	<div class="col-md-8 nopadL">
		...
		<div class="col-md-4 col-sm-6 nopadL">
            ...
            <div class="col-md-8 col-sm-3 padclr">
...
<!--<button type="submit" class="btn btn-default" data-toggle="modal" data-target="#modal_Disc">Post Discussion</button>-->
        <button type="submit" name="Submit_diss" class="btn btn-default" >Post Document</button>
