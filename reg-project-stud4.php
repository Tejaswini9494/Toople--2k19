				...
				<form method="post" id="form_techskills_reg">
					...
					<table class="table table-striped border">
						...
						<tr>
						  ...
						  <td><span class="form-group">
						    <input type="text" name="s_duration" maxlength="20" id="s_duration" class="form-control" placeholder="Duration" value="<?php echo $s_duration;?>"/>
						    </span></td>
						  <td>
...
$statement1s->fetch();
		...
		?>   
			...
			<tr>
				...
				<td align="right"><a href="reg-project-stud4.php?edit_id=<?php echo $s_technical_id;?>"><i class="fa fa-pencil edit"></i></a><a class="delete" href="reg-project-stud4.php?delete_id=<?php echo $s_technical_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
				</table>
				</div>
...
function empty_form(val1){
    ...
    $("#form_techskills_reg").find("input[type=text],input[type=tel],select").val("");
}
