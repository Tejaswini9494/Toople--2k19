...
$mainUrlSI="http://tooople.com/dev18/";
...
$sql1 = "SELECT proj_id, project_id, name, category, proj_created_by, proj_status, creation_date, termination_date, proj_abstract, notes, duration, dev_platform, busi_domain, proj_img, status FROM  too_projects  WHERE proj_id='$pid'";
$statement1=$mysqli->prepare($sql1);
$statement1->execute();
$statement1->store_result();
$statement1->bind_result($proj_id, $project_id, $name, $category, $proj_created_by, $proj_status, $creation_date, $termination_date, $proj_abstract, $notes, $duration, $dev_platform, $busi_domain, $proj_img, $status);
$statement1->fetch();
		...
		<div class="col-md-8"><!--------col-md-9-------->
					...
					<div class="col-md-3">
						<div class="projdet">
							...
							<div class="col-md-9 padclr">
								...
								<span class="projDet_Con"><?php echo $proj_created_by; ?></span>
							</div>	
						</div>
					</div>
					<div class="col-md-3">
			...
			-->
				...
				<div class="projDetail_img">
					<img src="uploads/<?php echo $proj_img; ?>" width="100%">
				</div>
				<div class="gap30"></div>
				-->
				<div class="proBox">
		...
		<div class="col-md-4"><!-----col-md-3-------->
			<div class="projDetail_rhs"><!-----projDetail_rhs-------->
				...
				<div class="rhs_cat">
					...
					<?php
						$query7= "SELECT COUNT(a.proj_id), b.category_name, b.category_id FROM  too_projects a, master_category b  WHERE a.proj_id!='' AND a.status='A' AND b.category_for='13' AND a.category=b.category_id AND b.category_id='$category' GROUP BY a.category";
				...
				<div class="rhs_cat">
					...
					<ul class="projRhsList">
					<?php
						$query8= "SELECT COUNT(a.proj_id), b.category_name, b.category_id FROM  too_projects a, master_category b  WHERE a.proj_id!='' AND a.status='A' AND b.category_for='3' AND a.dev_platform=b.category_id AND b.category_id='$dev_platform' GROUP BY a.dev_platform";
						//echo $query8;
				...
				<div class="rhs_cat">
					<!--<h5 class="projRhsTit">BUSINESS DOMAIN</h5>
		                        <span class="separateLine"></span>
					<div class="gap10"></div>-->
					<ul class="projRhsList">
					<?php
						$query8= "SELECT COUNT(a.proj_id), b.category_name, b.category_id FROM  too_projects a, master_category b  WHERE a.proj_id!='' AND a.status='A' AND b.category_for='18' AND a.busi_domain=b.category_id AND b.category_id='$busi_domain' GROUP BY a.busi_domain";
						//echo $query8;
						$statement8=$mysqli->prepare($query8);
						$statement8->store_result();
						$statement8->bind_result($busidomain_count, $busidomain_name, $busidomain_id);
						$statement8->execute();
						while($statement8->fetch()) {
					?>
						<li class="<?php if($busidomain_id==$pctid) { echo 'active'; } ?>">
							<a href="tooprojects.php?pbdcid=<?php echo $busidomain_id; ?>"><?php echo $busidomain_name; ?></a>
							<span class="pull-right"><?php echo $busidomain_count; ?></span>
						</li>
					<?php } $statement8->close(); ?>
					</ul>
				</div>
				...
				<div class="rhs_cat">
					...
					<!--	<li><i class="fa fa-database"></i>&nbsp;Project Status<span class="pull-right"><?php echo getcategoryname($proj_status); ?></span></li>	-->
						<li><i class="fa fa-clock-o"></i>&nbsp;Duration<span class="pull-right"><?php echo $duration; ?> Week(s)</span></li>
				...
				<div class="rhs_cat">
					<h5 class="projRhsTit">SHARE <i class="fa fa-share-alt-square font18"></i></h5>
		                        <span class="separateLine"></span>
					<div class="gap10"></div>
					<div class="row">
						<div class="col-xs-3">
							<div class="fb-share-button" 
							    data-href="<?php echo $mainUrlSI.'tooprojects_view.php?pid='.$pid; ?>" 
							    data-layout="button" data-size="small" data-mobile-iframe="true">
							</div>
						</div>
						<div class="col-xs-3">
							<div class="g-plus" data-action="share" data-height="24" data-href="<?php echo $mainUrlSI.'tooprojects_view.php?pid='.$pid; ?>"></div>
						</div>
						<div class="col-xs-3">
							<script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: en_US</script>
							<script type="IN/Share" data-url="<?php echo $mainUrlSI.'tooprojects_view.php?pid='.$pid; ?>"></script>
						</div>
					</div>
					<div class="gap10"></div>
				</div>
