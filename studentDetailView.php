...
$sql_personalinfo = "SELECT user_id,s_first_name,s_last_name,s_dob,s_gender,s_identify_number FROM student_info  where user_id='$id'";
$sql_personal_info=$mysqli->prepare($sql_personalinfo);
$sql_personal_info->execute();
$sql_personal_info->store_result();
$sql_personal_info->bind_result($user_id,$s_first_name,$s_last_name,$s_dob,$s_gender,$s_identify_number);
...
?>
	<tr>
		...
		<td><?php echo $s_institution_country;?></td>
		<td><?php echo $s_institution_state;?></td>
		<td><?php echo $s_institution_city;?></td>
