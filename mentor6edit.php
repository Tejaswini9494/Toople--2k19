				...
				<div class="table-responsive">
					...
					<table width="100%" class="table table-striped border">
						...
						<tr>
						  ...
						  <td><span class="form-group">
						    <input type="text" name="s_job_role" id="s_job_role"value="<?php echo $s_job_role;?>" class="form-control" />
						  </span></td>
						  <td><span class="form-group">
						    <input type="text" name="s_start_date" id="s_start_date" value="<?php echo $s_date;?>"class="dateIcon form-control" readonly/>
						  </span></td>
						  <td><span class="form-group">
						    <input type="text" name="s_end_date" id="s_end_date" value="<?php echo $e_date;?>"class="dateIcon form-control" readonly/>
						  </span></td>
...
while($statement1->fetch()) {
		...
		?>
			...
			<tr>
				...
				<td><?php echo $s_job_role;?></td>
				<td><?php echo $sdate;?></td>
				<td><?php echo $edate;?></td>
				

				<td align="right"><a href="mentor6edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> &edit_id=<?php echo $s_experience_id;?>"><i class="fa fa-pencil edit"></i></a><a id="delete" href="mentor6edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> & delete_id=<?php echo $s_experience_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
					</table>
				</div>
