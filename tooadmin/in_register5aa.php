	<!------------>
	<h3>Recruiting Organization Details</h3>
	<div class="gap10"></div>
	<div class="item1">
		<div class="gap20"></div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<input type="text" name="" id="" class="form-control" placeholder="Website">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<input type="text" name="" id="" class="form-control" placeholder="Language">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<input type="tel" name="" id="" class="form-control" placeholder="Fax Number">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
...
<option value="ZW">Zimbabwe </option>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<input type="text" name="" id="" class="form-control" placeholder="PAN Number">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
		...
		<div class="form-group">
			<label class="col-sm-3 text-right">TIN Number <span class="red">*</span></label>
			<div class="col-sm-9">
				<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-file-text"></i></span>
				<input type="text" name="" id="" class="form-control" placeholder="TIN Number">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<input type="text" name="" id="" class="form-control" placeholder="Service Tax Number">
				</div>
				<div class="gap1"></div>
				<span for="" class="errors"></span>
			</div>
	...
	<!------------>
		...
		<div class="gap10"></div>
		<a class="btn submitM" id="" href="#register5ab" data-toggle="tab">Save & Proceed</a> &nbsp;
