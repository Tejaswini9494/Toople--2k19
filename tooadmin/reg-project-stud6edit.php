...
if(isset($submit_details)){
	...
	header("location:reg-project-stud6edit.php?user_id=$user_id&userType=$userType"); 
	
}
if(isset($save_submit)){
	header("location:userView.php?type=$userType"); 
...
<div class="formss">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<div class="liLine"></div>
			<a href="reg-project-stud3edit.php?user_id=<?php echo $user_id;?>&userType=<?php echo $userType;?>"></a>
			<div class="gap10"></div>Educational Qualification
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="reg-project-stud4edit.php?user_id=<?php echo $user_id;?>&userType=<?php echo $userType;?>"></a>
			<div class="gap10"></div>Technical Skills
		</li>
		<li class="active">
			<div class="liLine"></div>
			<a href="reg-project-stud5edit.php?user_id=<?php echo $user_id;?>&userType=<?php echo $userType;?>"></a>
...
$statement1s->fetch();
		...
		?>
			...
			<tr>
				...
				<td align="right"><a href="reg-project-stud6edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> &edit_id=<?php echo $s_experience_id;?>"><i class="fa fa-pencil edit"></i></a><a class="del" id="delete" href="reg-project-stud6edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> & delete_id=<?php echo $s_experience_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
					</table>
				</div>
