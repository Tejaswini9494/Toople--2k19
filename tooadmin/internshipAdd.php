...
if(isset($ins_submit)) {
	...
	if($insid!='') {
		$tsdate=sysConvert($tsdate);
		$tedate=sysConvert($tedate);
		$doi=sysConvert($doi);
...
if($insid!='') { 
	...
	$ts_date=sysDBDateConvert1($tsdate);
	$te_date=sysDBDateConvert1($tedate);
	$doi=sysDBDateConvert1($doi);
...
<form id="form_ins" method="POST" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<input type="text" name="job" id="job" class="form-control" value="<?php echo $job; ?>">
			</div>
			<div class="gap1"></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<input type="text" name="tsdate" id="tsdate" class="form-control" value="<?php echo $ts_date; ?>"readonly>
			</div>
			<div class="gap1"></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
			<input type="text" name="tedate" id="tedate" class="form-control" value="<?php echo $te_date; ?>"readonly>
			</div>
			<div class="gap1"></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<input type="text" name="doi" id="doi" class="form-control date" value="<?php echo $doi; ?>">
			</div>
			<div class="gap1"></div>
