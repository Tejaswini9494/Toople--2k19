...
$path = "../uploads/student/";
		...
		$query = "UPDATE student_info SET s_first_name=?,s_last_name=?,s_dob=?,s_gender=?,status=?,s_identify_number=? $imgUp where user_id='$user_id'";
		$statement= $mysqli->prepare($query);  
		$statement->bind_param('sssssi',$s_first_name, $s_last_name,$s_dob1,$s_gender,$status,$s_identify_number);
		$statement->execute();
			...
			<div class="item1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input name="s_institution_name" id="s_institution_name" value="<?php echo $name;?>" class="form-control" readonly>
						</div>
						<div class="gap1"></div>
