...
{	
	...
	header("location:reg-institution2edit.php?user_id=$user_id&user_type=$user_type");
}
...
$path = "../uploads/customer_organisation/";
	...
	$querys = "INSERT INTO co_representative_details(user_id,coordinator_id,cr_name,cr_id_no,cr_designation,cr_language,cr_email,cr_alt_email,cr_phone,cr_alt_phone,cr_country,cr_state,cr_city,cr_pincode,cr_photo,created_on) VALUES ('$user_id','$id','$cr_name','$cr_id_no','$cr_designation','$cr_language','$cr_email','$email','$cr_phone','$phone','$cr_country','$cr_state','$cr_city','$cr_pincode','$name_file',now())";
...
cr_city=?,cr_pincode=?,cr_photo=? where co_representative_details_id='$update_id'";
	...
	$statement_up1->bind_param('sssssssiiiss',$cr_name,$cr_id_no,$cr_designation,$cr_language,$email,$cr_phone,$phone,$cr_country,$cr_state,$cr_city,$cr_pincode,$name_file);
			...
			<form id="form_reg-institution2" method="post" enctype="multipart/form-data">
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="cr_name" id="cr_name" value="<?php echo $cr_name;?>" class="form-control" onkeypress="return alpha(event);" onchange="AllowOnlyAlphabates(this);" onpaste="return AllowOnlyAlphabates(this);" oncopy="return AllowOnlyAlphabates(this);" onblur="FormatString(this);" placeholder="Name" autofocus>
						</div>
						<div class="gap1"></div>
...
?>
						<tr>
							...
							<td align="right"><a href="reg-institution2edit.php?user_id=<?php echo $user_id;?> & user_type=<?php echo$user_type;?> & edit_id=<?php echo $co_representative_details_id;?>"><i class="fa fa-pencil edit"></i></a><a class="del" id="delete" href="reg-institution2edit.php?user_id=<?php echo $user_id;?> & user_type=<?php echo$user_type;?> & delete_id=<?php echo $co_representative_details_id;?>"><i class="fa fa-trash trash"></i></a></td>
			...
			<div class="col-sm-9 col-sm-push-3">
				...
				<a class="btn submitM" id="" href="user3View.php?type=<?php echo $user_type;?>">Submit</a>
