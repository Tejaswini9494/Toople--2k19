...
<div class="item1">
	...
	<div class="form-group">
		<label class="col-sm-4 text-right">Are You? <span class="red">*</span></label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-4 text-right">Representative for Service Provider Type: <span class="red">*</span></label>
		<div class="col-sm-6">
			<select name="serviceprovider_rsp" id="serviceprovider_rsp" class="form-control" required="required" disabled>
				<option value="">Select</option>		
				<option value="1" selected>Mentor</option>
				<option value="2">Content Provider</option>
			</select>
		</div>
		<div class="gap1"></div>
	</div>
