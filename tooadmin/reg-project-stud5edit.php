...
if(isset($submit_details)){
	...
	header("location:reg-project-stud5edit.php?user_id=$user_id&userType=$userType");
}
...
?> 
			<tr>
				...
				<td align="right"><a href="reg-project-stud5edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> &edit_id=<?php echo $s_certification_id;?>"><i class="fa fa-pencil edit"></i></a><a class="del" id="delete" href="reg-project-stud5edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> &delete_id=<?php echo $s_certification_id;?>"><i class="fa fa-trash trash"></i></a></td>
			</tr>
					<?php } ?>
					</table>
				</div>
