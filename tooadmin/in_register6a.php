...
$query = "UPDATE representative_service_provider SET rsp_org_name=?,rsp_email=?,rsp_web=?,rsp_lang=?,rsp_phone=?,rsp_country=?,rsp_state=?,rsp_city=?,rsp_postal=?,rsp_pan=?,rsp_tin=?,rsp_tax=?,rsp_bank_details=? where user_id='$id'";
...
$sql = "SELECT rsp_org_name,rsp_email,rsp_web,rsp_lang,rsp_phone,rsp_country,rsp_state,rsp_city,rsp_postal,rsp_pan,rsp_tin,rsp_tax,rsp_bank_details FROM representative_service_provider where user_id='$id'";
