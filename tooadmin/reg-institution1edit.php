...
$s1="select user_id from customer_organisation where customer_organisation_id='$edit_id'";
...
co_tin_number=?,co_taxno=?,co_bank_details=?,status='$status' where user_id='$user_id'";
	...
	if(isset($proceed_submit)){
		...
		header("location:reg-institution1edit.php?user_id=$user_id&user_type=$user_type");
	}
}

$sql = "SELECT co_name,co_email,co_website,co_language,co_phone,co_fax,co_address,co_country,co_state,co_city,co_pincode,co_pan_number,co_tin_number,co_taxno,co_bank_details FROM customer_organisation where user_id='$user_id'";
...
<div class="formss formss1">
	...
	<div class="tab-content">
		<div class="tab-pane fade in active">
			...
			<!------------>
			<h3><?php echo $name12;?> Organization Details</h3>
			<div class="gap10"></div>
			...
			<div class="item1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="co_email" id="co_email" value="<?php echo $user_email3;?>" class="form-control" placeholder="Email" readonly>
						</div>
						<div class="gap1"></div>
...
(function($,W,D)
{
    ...
    JQUERY4U.UTIL =
    {
		...
		alphanumeric :"Kindly enter only characters & numbers",
		},
