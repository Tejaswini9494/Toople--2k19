				...
				<form method="post" id="form_techskills_reg">
					<table width="100%" class="table table-striped border">
						...
						<tr>
						  ...
						  <td><span class="form-group">
						    <input type="text" name="s_start_date" id="s_start_date" class="dateIcon form-control" value="<?php echo $s_yos;?>" style="cursor:pointer;" readonly/>
						  </span></td>
						  <td><span class="form-group">
...
$statement1s->fetch();
		...
		?>   
			...
			<tr>
				...
				<td align="right"><a href="reg-project-stud4edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo $userType;?> &edit_id=<?php echo $s_technical_id;?>"><i class="fa fa-pencil edit"></i></a><a class="del" id="delete" href="reg-project-stud4edit.php?user_id=<?php echo $user_id; ?> & userType=<?php echo$userType;?> &delete_id=<?php echo $s_technical_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
					</table>
				</div>
