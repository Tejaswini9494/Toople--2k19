...
Representative of Recruiting Organization   &raquo; Add / Edit</h3>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select required="required" class="form-control" id="usertype" name="usertype" disabled>
				...
				<option value="7" selected>Representative of Recruiting Organization</option>
