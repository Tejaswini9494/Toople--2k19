...
include("header.php");?> 
<h3>
<a href="user3View.php" class="submitM pull-right">View</a>
Representative of Customer Organization   &raquo; Add / Edit</h3>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select required="required" class="form-control" id="usertype" name="usertype" disabled>
				...
				<option value="5" selected>Representative of Customer Organization</option>
