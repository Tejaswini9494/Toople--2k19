...
<h1>
<span class="back">
<a href="metaMentorPricingAdd.php">Add</a>
</span>
 Settings  &raquo;  Meta  &raquo;    Mentor Pricing  &raquo;  View 
</h1>
...
<form name="frm1" id="frm1" action="" method="post" >
    <table align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="right"> </td>
		<td><input name="search_type" id="search_type" class="form-control" placeholder="Mentor Type" type="text" value="<?php echo $search_type; ?>"/></td>
        <td><select name="search_currency" id="search_currency" class="boxM">
		<option value=''> Select Currency </option>
		<option value="">Select</option>
		<?php while($statement1->fetch()) { ?>
			<option value="<?php echo $country_id; ?>" <?php if($country_id==$search_currency) { echo "selected"; } ?>><?php echo $currency."-".$country_name; ?></option>
		<?php } ?>
        </select>
        </td>
...
<table id="dataTable" class="table table-bordered table-striped tabBorder">
  <thead>
    <tr class="tr1">
      ...
      <td><strong><a href="#" class="linkB"> Mentor Type </a></td>
      <td><strong><a href="#" class="linkB"> Currency </a></td>
      <td><strong><a href="#" class="linkB"> Mentor Fees(Per Hour) </a></td>
...
?>
    <tr class="tr">
      ...
      <td align="left"><a href="metaMentorPricingEdit.php?id=<?php echo $mentor_price_id; ?>"><i class="fa fa-pencil-square-o" ></i></a></td>
      <td><?php echo $i;?></td>
