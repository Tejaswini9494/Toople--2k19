...
include("header.php");?> 
<h3>
<!--<a href="user4Add.php" class="submitM pull-right">Add</a>-->
Content Provider of Service Provider Organization &raquo; List View </h3>
...
<table id="dataTable" class="table table-bordered table-striped tabBorder">
  <thead>
    ...
    <tr class="tr">
      ...
      <td align="center"><a href="user4Add.php"><img src="images/edit.png" alt="edit" /></a></td>
      <td class="td_txt">Silver</td>
      <td class="td_txt"><a href="profileView4.php">Demo</a></td>
