...
include("header.php");?> 
<h3>
<!--<a href="user5Add.php" class="submitM pull-right">Add</a>-->
Representative of Recruiting Organization &raquo; List View </h3>
...
<table id="dataTable" class="table table-bordered table-striped tabBorder">
  <thead>
    ...
    <tr class="tr">
      ...
      <td align="center"><a href="user5Add.php"><img src="images/edit.png" alt="edit" /></a></td>
      <td class="td_txt">Silver</td>
      <td class="td_txt"><a href="profileView5.php">Demo</a></td>
