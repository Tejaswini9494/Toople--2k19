...
if(isset($save_submit) || isset($proceed_submit)){
	...
	$statement->execute();
	header("location:mentor2edit.php?user_id=$user_id&userType=$userType");


if(isset($proceed_submit)){
	header("location:mentor3edit.php?user_id=$user_id&userType=$userType");
}
}
			...
			<div class="item1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_primary_contact" id="s_primary_contact"  value="<?php echo $s_primary_contact;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_email_id" id="s_email_id"   class="form-control" maxlength="50" value="<?php echo $umail;?>" readonly/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-envelope"></i></span>
						<input type="text" name="s_alternate_email_id"   id="s_alternate_email_id" class="form-control" maxlength="50" value="<?php echo $s_alternate_email_id;?>"/>
						</div>
						<div class="gap1"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="text" name="s_secondary_contact"   value="<?php echo $s_secondary_contact;?>"/>
						</div>
						<div class="gap1"></div>
...
function empty_form(val1){
        $("#"+val1).closest('#form_contactinfo_reg').find("input[type=text], input[type=radio], input[type=tel], select, textarea").val("");
}
</script>
