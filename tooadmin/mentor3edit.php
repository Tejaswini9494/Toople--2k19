 ...
 while($statement1->fetch()) {
					...
					?>
						<tr>
							...
							<td align="right">
<a href="mentor3edit.php?user_id=<?php echo $user_id; ?>&userType=<?php echo $userType;?>&edit_id=<?php echo $s_qualification_id;?>"><i class="fa fa-pencil edit"></i></a>
<a class="del" id="delete" href="mentor3edit.php?user_id=<?php echo $user_id;?> & userType=<?php echo $userType;?>&delete_id=<?php echo $s_qualification_id;?>"><i class="fa fa-trash trash"></i></a></td>
						</tr>
					<?php } ?>
					</table>
				</div>
