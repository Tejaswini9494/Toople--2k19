<?php 
$page="register2";
$tit="Register &raquo; Service Provider";
$ses="no";
include("head.php"); ?>
 <style>
...
<div class="gap30"></div>
<h1 >Register &raquo; Service Provider </h1>
...
<h3>Type of Users</h3>
	...
	<div class="item1 text-center">
        ...
        <label><input type="radio" name="11" />  Mentor </label>  &nbsp;&nbsp;&nbsp;
         <label><input type="radio" name="11" /> Content Provider</label>
