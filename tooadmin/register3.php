<?php 
$page="register";
$tit="Register &raquo; Institution / Organisation";
$ses="no";
include("head.php"); ?>
 <style>
...
<div class="gap30"></div>
<h1>Register &raquo; Institution / Organisation  </h1>
...
<form name="reg" method="post" id="seeker_valid">
   ...
   <div class="form-group">
			<label class="col-sm-3 text-right">Institution / Organisation Name <span class="red">*</span></label>
			<div class="col-sm-9">
				<div class="input-group">
...
<option value="197">Other International </option>
    ...
    <div class="form-group">
			<label class="col-sm-3 text-right">Representative Name <span class="red">*</span></label>
			<div class="col-sm-9">
				<div class="input-group">
